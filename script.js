...
$("#searchButton").on("click", function () {
    ...
    fetch('http://open.mapquestapi.com/geocoding/v1/address?key=roGqv4kTHPoSVNTzzl7cTbyMNx2B7A5X&location=' + cityInput.value)
    ...
    fetch('https://api.openweathermap.org/data/2.5/onecall?lat=' + lat + '&lon=' + lng + '&units=imperial&appid=bc6666ba49703d9bc43c8a571875f5a6')
        ...
        .then(data => {
            ...
            for(i = 1; i < 6; i++){
                ...
                $(newDay).append("<img class = 'bg-secondary rounded' src = 'http://openweathermap.org/img/wn/" + data.daily[i].weather[0].icon + "@2x.png' width=50 height=50 >");
